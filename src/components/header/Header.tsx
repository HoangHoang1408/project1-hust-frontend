          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              <div className="flex space-x-3">
                <Link to="/" className="flex-shrink-0 flex items-center pr-3">
                ...
                <Link
                  to={"/aboutus"}
                  className="flex place-items-center my-auto text-sm text-gray-900 font-semibold px-3 py-2 h-3/5 cursor-pointer hover:bg-indigo-200 transition rounded-md"
                >
                  Giới thiệu
                </Link>
              </div>
